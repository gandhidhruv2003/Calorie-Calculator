...
enc_dict = {"Almonds": 0, "Amaranth leaves": 1, "Amaranth seed, Black": 2, "Anise seeds": 3, "Apple": 4, "Apricot, dried": 5, 
...
def calculate():
    if request.method == "POST":
        ...
        return "<html><body><h1>Send a POST request to calculate the calorie</h1></body></html>"
